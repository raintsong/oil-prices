  ...
  return (
    <header className="py-6 border-b border-slate-200 dark:border-slate-800/50 mb-6">
      ...
      <button 
        onClick={onRefresh}
        disabled={loading}
        className="w-full bg-blue-600 hover:bg-blue-500 text-white text-xs font-black py-3 rounded-2xl shadow-lg uppercase tracking-widest transition-all active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed"
      >
