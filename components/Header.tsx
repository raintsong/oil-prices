      ...
      <div className="flex justify-between items-center mb-4">
        <div>
          ...
          <div className="flex items-center gap-2 mt-1">
            ...
            {/* IMPORTANT: Wrap the Link in its own div to separate it 
               from the title text's click area 
            */}
            <div className="flex items-center">
                <Link 
                href="/admin" 
                className="p-1 text-slate-400 hover:text-blue-500 transition-colors z-10" 
                title="Admin Update"
                // This prevents the click from "bubbling" up to any parent elements
